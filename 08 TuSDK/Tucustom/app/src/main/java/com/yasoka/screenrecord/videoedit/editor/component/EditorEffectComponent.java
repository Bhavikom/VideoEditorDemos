package com.yasoka.screenrecord.videoedit.editor.component;
...
import com.yasoka.screenrecord.sdk.core.lasque.tusdk.core.view.recyclerview.TuSdkLinearLayoutManager;
import com.yasoka.screenrecord.sdk.video.lasque.tusdk.core.seles.sources.TuSdkEditorEffector;
import com.yasoka.screenrecord.sdk.video.lasque.tusdk.core.seles.sources.TuSdkEditorPlayer;
import com.yasoka.screenrecord.sdk.video.lasque.tusdk.core.seles.sources.TuSdkEditorPlayerImpl;
import com.yasoka.screenrecord.sdk.video.lasque.tusdk.core.seles.sources.TuSdkMovieEditor;
...
import com.yasoka.screenrecord.videoedit.editor.MovieEditorController;
import com.yasoka.screenrecord.videoedit.utils.TusdkConstants;
import com.yasoka.screenrecord.videoedit.views.ConfigViewParams;
import com.yasoka.screenrecord.videoedit.views.ConfigViewSeekBar;
import com.yasoka.screenrecord.videoedit.views.EffectComponetAdapter;
import com.yasoka.screenrecord.videoedit.views.MagicRecyclerAdapter;
import com.yasoka.screenrecord.videoedit.views.SceneRecyclerAdapter;
import com.yasoka.screenrecord.videoedit.views.TabPagerIndicator;
import com.yasoka.screenrecord.videoedit.views.TimeRecyclerAdapter;
import com.yasoka.screenrecord.videoedit.views.editor.TuSdkMovieScrollPlayLineView;
import com.yasoka.screenrecord.videoedit.views.editor.color.ColorView;
import com.yasoka.screenrecord.videoedit.views.editor.playview.TuSdkMovieScrollView;
import com.yasoka.screenrecord.videoedit.views.editor.playview.TuSdkRangeSelectionBar;
...
import static com.yasoka.screenrecord.videoedit.utils.TusdkConstants.EDITORFILTERS;

//import static org.lasque.tusdkvideodemo.utils.TusdkConstants.EDITORFILTERS;
...
public class EditorEffectComponent extends EditorComponent {
    ...
    public static class SceneEffectFragment extends EffectFragment {
        ...
        public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
            ...
            mSceneAdapter.setSceneList(Arrays.asList(TusdkConstants.SCENE_EFFECT_CODES));
...
//                            }
    ...
    public static class TimeEffectFragment extends EffectFragment {
        ...
        public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
            ...
            mTimeAdapter.setTimeList(Arrays.asList(TusdkConstants.TIME_EFFECT_CODES));
                ...
                public void onMaxValueExceed() {
                    ThreadHelper.postDelayed(new Runnable() {
                        ...
                        public void run() {
                            ...
                            @SuppressLint("StringFormatMatches") String tips = String.format(getString(R.string.lsq_max_time_effect_tips), maxTime);
...
//        private LineView mLineView;
        ...
        public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
            ...
            mParticleAdapter.setMagicList(Arrays.asList(TusdkConstants.PARTICLE_CODES));
            ...
            mParticleAdapter.setItemCilckListener(new MagicRecyclerAdapter.ItemClickListener() {
                ...
                public void onItemClick(int position, MagicRecyclerAdapter.MagicViewHolder MagicViewHolder) {
                    ...
                    mCurrentIndex = position;
                    mCurrentParticleCode = TusdkConstants.PARTICLE_CODES[position];

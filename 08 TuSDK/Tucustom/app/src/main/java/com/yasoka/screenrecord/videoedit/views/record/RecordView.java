package com.yasoka.screenrecord.videoedit.views.record;
...
import com.yasoka.screenrecord.R;
...
import com.yasoka.screenrecord.sdk.core.lasque.tusdk.core.view.widget.button.TuSdkTextButton;
...
import com.yasoka.screenrecord.sdk.video.lasque.tusdk.core.utils.hardware.TuSdkRecorderVideoCameraImpl;
import com.yasoka.screenrecord.sdk.video.lasque.tusdk.video.editor.TuSdkMediaComicEffectData;
...
import com.yasoka.screenrecord.sdk.video.lasque.tusdk.video.editor.TuSdkMediaPlasticFaceEffect;
import com.yasoka.screenrecord.sdk.video.lasque.tusdk.video.editor.TuSdkMediaSkinFaceEffect;
import com.yasoka.screenrecord.videoedit.utils.TusdkConstants;
import com.yasoka.screenrecord.videoedit.views.BeautyPlasticRecyclerAdapter;
import com.yasoka.screenrecord.videoedit.views.BeautyRecyclerAdapter;
import com.yasoka.screenrecord.videoedit.views.FilterConfigSeekbar;
import com.yasoka.screenrecord.videoedit.views.FilterRecyclerAdapter;
import com.yasoka.screenrecord.videoedit.views.HorizontalProgressBar;
import com.yasoka.screenrecord.videoedit.views.ParamsConfigView;
import com.yasoka.screenrecord.videoedit.views.TabPagerIndicator;
import com.yasoka.screenrecord.videoedit.views.props.PropsItemMonsterPageFragment;
import com.yasoka.screenrecord.videoedit.views.props.PropsItemPageFragment;
import com.yasoka.screenrecord.videoedit.views.props.PropsItemPagerAdapter;
import com.yasoka.screenrecord.videoedit.views.props.StickerPropsItemPageFragment;
import com.yasoka.screenrecord.videoedit.views.props.model.PropsItem;
import com.yasoka.screenrecord.videoedit.views.props.model.PropsItemCategory;
import com.yasoka.screenrecord.videoedit.views.props.model.PropsItemMonsterCategory;
import com.yasoka.screenrecord.videoedit.views.props.model.PropsItemStickerCategory;
...
import static com.yasoka.screenrecord.sdk.video.lasque.tusdk.video.editor.TuSdkMediaEffectData.TuSdkMediaEffectDataType.TuSdkMediaEffectDataTypeFilter;
import static com.yasoka.screenrecord.sdk.video.lasque.tusdk.video.editor.TuSdkMediaEffectData.TuSdkMediaEffectDataType.TuSdkMediaEffectDataTypePlasticFace;
import static com.yasoka.screenrecord.sdk.video.lasque.tusdk.video.editor.TuSdkMediaEffectData.TuSdkMediaEffectDataType.TuSdkMediaEffectDataTypeSkinFace;
...
import org.lasque.tusdkvideodemo.utils.TusdkConstants;
...
public class RecordView extends RelativeLayout
{
   ...
   // 道具布局 贴纸+哈哈镜
    ...
    protected void init(Context context)
    {
        ...
        minTimeLayoutParams.leftMargin = (int) (((float) TusdkConstants.MIN_RECORDING_TIME * TuSdkContext.getScreenSize().width) / TusdkConstants.MAX_RECORDING_TIME)
    ...
    public void setUpCamera(Context context, TuSdkRecorderVideoCameraImpl camera)
    {
        ...
        ThreadHelper.postDelayed(new Runnable() {
            ...
            @Override
            public void run() {
                changeVideoFilterCode(Arrays.asList(TusdkConstants.VIDEOFILTERS).get(mCurrentPosition));
            }
            ...
            switch (event.getAction())
            {
                ...
                case MotionEvent.ACTION_UP:
                    ...
                    else if(mRecordMode == RecordType.SHORT_CLICK_RECORD)
                    {
                        ...
                        {
                            if (mCamera.getMovieDuration() >= TusdkConstants.MAX_RECORDING_TIME) {
                                String msg = getStringFromResource("max_recordTime") + TusdkConstants.MAX_RECORDING_TIME + "s";
    ...
    protected void initFilterListView()
    {
        ...
        // 设置动漫滤镜集合
        this.mComicsFilterAdapter.setFilterList(Arrays.asList(TusdkConstants.COMICSFILTERS));

        // 设置普通滤镜集合
        this.mFilterAdapter.setFilterList(Arrays.asList(TusdkConstants.VIDEOFILTERS));
    }
    ...
    {
        List<TuSdkMediaEffectData> filterEffects = mCamera.mediaEffectsWithType(TuSdkMediaEffectDataTypeSkinFace);
...
//        TLog.e("filterArg -- %s",filterArg.getPrecentValue());
    ...
    {
        List<TuSdkMediaEffectData> filterEffects = mCamera.mediaEffectsWithType(TuSdkMediaEffectDataTypePlasticFace);
        ...
        public void onClick(View v)
        {
            switch (v.getId())
            {
                ...
                case R.id.lsq_confirmWrap:
                    if(mCamera.getMovieDuration() < TusdkConstants.MIN_RECORDING_TIME){
                        String msg = getStringFromResource("min_recordTime") + TusdkConstants.MIN_RECORDING_TIME + "s";
                        TuSdk.messageHub().showToast(mContext, msg);
                        return;
                    }
                    // 启动录制隐藏比例调节按钮

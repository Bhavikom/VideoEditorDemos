...
import com.yasoka.screenrecord.videoedit.views.CompoundConfigView;
...
import com.yasoka.screenrecord.videoedit.views.MvRecyclerAdapter;
...
import static com.yasoka.screenrecord.sdk.video.lasque.tusdk.video.editor.TuSdkMediaEffectData.TuSdkMediaEffectDataType.TuSdkMediaEffectDataTypeAudio;
import static com.yasoka.screenrecord.sdk.video.lasque.tusdk.video.editor.TuSdkMediaEffectData.TuSdkMediaEffectDataType.TuSdkMediaEffectDataTypeSticker;
import static com.yasoka.screenrecord.sdk.video.lasque.tusdk.video.editor.TuSdkMediaEffectData.TuSdkMediaEffectDataType.TuSdkMediaEffectDataTypeStickerAudio;
...
//    private LineView mTimeLineView;
    ...
    private CompoundConfigView getVoiceVolumeConfigView() {
        if (mVoiceVolumeConfigView == null) {
            ...
            params.appendFloatArg(("originIntensity"), mMasterVolume);
            params.appendFloatArg(("dubbingIntensity"), mOtherVolume);

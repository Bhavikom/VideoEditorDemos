...
public class FilterConfigSeekbar extends TuSdkRelativeLayout
{
	...
	public interface FilterConfigSeekbarDelegate
	{
		 ...
		 *            滤镜参数
		 */
		void onSeekbarDataChanged(FilterConfigSeekbar seekbar, SelesParameters.FilterArg arg);
	}
	 ...
	 * @param arg
	 */
	public void setFilterArg(SelesParameters.FilterArg arg)
	{
		mFilterArg = arg;
    ...
    public void setSelesFilter(SelesOutInput filter)
    {
       ...
       this.mFilter = (SelesParameters.FilterParameterInterface) filter;

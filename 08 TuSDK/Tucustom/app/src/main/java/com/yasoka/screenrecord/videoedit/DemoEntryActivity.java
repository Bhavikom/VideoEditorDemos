...
import com.yasoka.screenrecord.sdk.core.lasque.tusdk.impl.view.widget.TuProgressHub;
import com.yasoka.screenrecord.sdk.core.lasque.tusdk.modules.components.ComponentActType;
import com.yasoka.screenrecord.videoedit.album.AlbumUtils;
import com.yasoka.screenrecord.videoedit.editor.MovieEditorCutActivity;
import com.yasoka.screenrecord.videoedit.record.MovieRecordFullScreenActivity;
import com.yasoka.screenrecord.videoedit.utils.Constants;
import com.yasoka.screenrecord.videoedit.utils.PermissionUtils;
...
public class DemoEntryActivity extends TuFragmentActivity {
    ...
    {
        @Override
        public void onAlertConfirm(android.support.v7.app.AlertDialog dialog) {
        ...
        @Override
        public void onAlertCancel(android.support.v7.app.AlertDialog alertDialog) {
            super.onAlertCancel(alertDialog);
        }
    };
}

package com.yasoka.screenrecord.videoedit.record;
...
import com.yasoka.screenrecord.sdk.video.lasque.tusdk.core.utils.hardware.TuSdkRecorderVideoEncoderSetting;
import com.yasoka.screenrecord.sdk.video.lasque.tusdk.core.video.TuSDKVideoResult;
import com.yasoka.screenrecord.videoedit.SimpleCameraActivity;
import com.yasoka.screenrecord.videoedit.editor.MovieEditorActivity;
import com.yasoka.screenrecord.videoedit.utils.TusdkConstants;
import com.yasoka.screenrecord.videoedit.views.record.RecordView;
...
//        hideNavigationBar();
    ...
    protected void initCamera()
    {
        ...
        mVideoCamera.setMinRecordingTime(TusdkConstants.MIN_RECORDING_TIME);
        mVideoCamera.setMaxRecordingTime(TusdkConstants.MAX_RECORDING_TIME);
        ...
        if(!mVideoCamera.isDirectEdit()) {
            ...
            ThreadHelper.postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    intent.putExtra("videoPaths", result.videoPath.getAbsolutePath());

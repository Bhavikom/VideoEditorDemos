...
import com.yasoka.screenrecord.sdk.core.lasque.tusdk.core.media.codec.suit.mutablePlayer.TuSdkMediaMutableFilePlayer;
...
import com.yasoka.screenrecord.videoedit.ScreenAdapterActivity;
import com.yasoka.screenrecord.videoedit.album.MovieInfo;
import com.yasoka.screenrecord.videoedit.views.editor.EditorCutView;
import com.yasoka.screenrecord.videoedit.views.editor.SpeedView;
import com.yasoka.screenrecord.videoedit.views.editor.playview.TuSdkMovieScrollContent;
...
import static com.yasoka.screenrecord.sdk.video.lasque.tusdk.api.audio.player.TuSDKMutiAudioPlayer.State.Playing;
...
public class MovieEditorCutActivity extends ScreenAdapterActivity {
    ...
    private void startCompound(){
        ...
        cuter.run(new TuSdkMediaProgress() {
            /**
             *  Crop progress callback
             * @param progress        Progress percentage 0-1
             * @param mediaDataSource Currently processed video media source
             * @param index           Currently processed video index
             * @param total           The total number of files that need to be processed
             */
            @Override
            ...
            /**
             *  Crop end callback
             * @param e If successful, it is Null
            ...
            public void onCompleted(Exception e, TuSdkMediaDataSource outputFile, int total) {
                ...
                intent.putExtra("videoPaths", outputFile.getPath());

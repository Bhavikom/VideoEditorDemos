...
import com.yasoka.screenrecord.sdk.video.lasque.tusdk.core.utils.hardware.TuSdkRecorderCameraSetting;
...
//        captureSetting.previewRatio = 0;
		...
		// 启用防闪烁功能，默认关闭。
		mVideoCamera.setAntibandingMode(CameraConfigs.CameraAntibanding.Auto);

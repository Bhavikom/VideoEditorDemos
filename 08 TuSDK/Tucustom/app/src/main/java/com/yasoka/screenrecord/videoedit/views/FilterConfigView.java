 ...
 *
 */
package com.yasoka.screenrecord.videoedit.views;
...
public class FilterConfigView extends TuSdkRelativeLayout
{
    ...
    {
        if (filter == null || !(filter instanceof SelesParameters.FilterParameterInterface))
        {
            return;
        }
        ...
        loadView();
        this.resetConfigView(this.getConfigWrap(), (SelesParameters.FilterParameterInterface) filter);
    }
     ...
     * @param filter
     */
    private void resetConfigView(LinearLayout configWrap, SelesParameters.FilterParameterInterface filter)
    {
        mFilter = filter;
        ...
        for (SelesParameters.FilterArg arg : params.getArgs())
        {
     ...
     * @return
     */
    private boolean checkIgnoredKey(SelesParameters.FilterArg arg, String[] ignoredKeys)
    {

...
import com.yasoka.screenrecord.sdk.video.lasque.tusdk.core.audio.TuSdkAudioRecordCuter;
...
import com.yasoka.screenrecord.videoedit.views.MusicRecyclerAdapter;
import com.yasoka.screenrecord.videoedit.views.editor.AudioRecordLayout;
...
import static com.yasoka.screenrecord.sdk.core.lasque.tusdk.core.TuSdkContext.getPackageName;
...
public class EditorMusicComponent extends EditorComponent {
    ...
    public View getBottomView() {
        if (mBottomView == null) {
            ...
            mMusicAdapter.setMusicList(Arrays.asList(TusdkConstants.AUDIO_EFFECTS_CODES));

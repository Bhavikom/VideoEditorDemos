...
import static com.yasoka.screenrecord.sdk.video.lasque.tusdk.core.seles.sources.TuSdkMovieEditor.TuSdkMovieEditorOptions.TuSdkMediaPictureEffectReferTimelineType.TuSdkMediaEffectReferInputTimelineType;
...
public class MovieEditorActivity extends FragmentActivity {
    ...
    private void initView(){
        mVideoPath = getIntent().getStringExtra("videoPaths");

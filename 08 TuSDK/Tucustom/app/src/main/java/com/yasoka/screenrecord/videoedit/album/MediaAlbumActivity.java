...
package com.yasoka.screenrecord.videoedit.album;
...
import com.yasoka.screenrecord.videoedit.MediaAlbumAdapter;
...
public class MediaAlbumActivity extends ScreenAdapterActivity {
    ...
    {
        @Override
        public void onAlertConfirm(android.support.v7.app.AlertDialog alertDialog) {
    ...
    private void initViews() {
        ...
        mMediaTabPagerIndicator.setTabItems(Arrays.asList("video","photo"));
    }

...
@TargetApi(18)
public class SelesEGLCoreWindow
  extends SelesEGLCore
{
  ...
  public TuSdkSize getSurfaceSize()
  {
    if (this.d == null)
    {
      TLog.w("%s getSurfaceSize need attachSurface first", new Object[] { "SelesEGLCoreWindow" });
      return null;
    }
    return this.d;
  }
  ...
  public SelesEGLCoreWindow(EGLContext paramEGLContext)
  {
    super(paramEGLContext, 1);
  }
  
  public boolean attachSurface(Surface paramSurface, boolean paramBoolean)
  {
    if (this.a != EGL14.EGL_NO_SURFACE)
    {
      TLog.w("%s surface already created", new Object[] { "SelesEGLCoreWindow" });
      return false;
    }
...
/* Location:              C:\Users\OM\Desktop\tusdkjar\TuSDKCore-3.1.0.jar!\org\lasque\tusdk\core\seles\egl\SelesEGLCoreWindow.class

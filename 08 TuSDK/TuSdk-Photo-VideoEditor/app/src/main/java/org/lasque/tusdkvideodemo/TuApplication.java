...
public class TuApplication extends TuSdkApplication
{
	...
	public void onCreate()
	{
		...
		/**
	     *  Specify the development mode, which needs to match the masters.key in lsq_tusdk_configs.json. If the devType is not found, the master field will be read by default.
		 * * If an application corresponds to multiple package names, you can use this method for integrated debugging.
	     */

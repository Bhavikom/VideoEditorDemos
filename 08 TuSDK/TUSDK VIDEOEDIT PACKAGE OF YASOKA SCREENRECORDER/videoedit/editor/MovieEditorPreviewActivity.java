...
import com.yasoka.screenrecord.videoedit.views.TuSDKMediaPlayer;
        ...
        public void onClick(View v) {
            switch (v.getId()){
                ...
                case R.id.lsq_next:
                    ...
                    Intent intent = null;
                    try {
                        intent = new Intent(MovieEditorPreviewActivity.this,MovieEditorCutActivity.class); // commented on 7th aug to open editro directrly without cutter
                        //intent = new Intent(MovieEditorPreviewActivity.this,MovieEditorActivity.class);
                        intent.putExtra("videoPaths",(Serializable)mVideoPaths);
                        //intent.putExtra("videoPaths",mVideoPaths.get(0).getPath());

...
import com.yasoka.screenrecord.helper.Helper;
...
public class TuSDKMediaPlayer extends FrameLayout {
    ...
    public void setVideoSize(SurfaceView surfaceView, int width, int height) {
        if (surfaceView != null) {
            ...
            String resolution = Helper.getResolution(mContext);
            String[] splited = resolution.split("x");
            int screenWidth = Integer.parseInt(splited[0]);
            int screenHeight = Integer.parseInt(splited[1]);

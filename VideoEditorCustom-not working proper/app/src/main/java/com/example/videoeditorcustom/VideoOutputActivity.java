...
public class VideoOutputActivity extends AppCompatActivity implements View.OnClickListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        output_button.setOnClickListener(this);
        output_button.setTextAppearance(this, R.style.blue_text_18_style);
    ...
    public void onClick(View v) {
        if (v.getId() == output_button.getId()) {
            releasePlayer();
